...
var init_countUp_min = __esm({
  "node_modules/countup.js/dist/countUp.min.js"() {
    ...
    CountUp = function() {
      function t(t2, i, n) {
        var s = this;
        this.endVal = i, this.options = n, this.version = "2.3.2", this.defaults = { startVal: 0, decimalPlaces: 0, duration: 2, useEasing: true, useGrouping: true, smartEasingThreshold: 999, smartEasingAmount: 333, separator: ",", decimal: ".", prefix: "", suffix: "", enableScrollSpy: false, scrollSpyDelay: 200, scrollSpyOnce: false }, this.finalEndVal = null, this.useEasing = true, this.countDown = false, this.error = "", this.startVal = 0, this.paused = true, this.once = false, this.count = function(t3) {
          ...
          if (n2 = o[0], a = o.length > 1 ? s.options.decimal + o[1] : "", s.options.useGrouping) {
            e = "";
            for (var l = 0, h = n2.length; l < h; ++l)
              0 !== l && l % 3 == 0 && (e = s.options.separator + e), e = n2[h - l - 1] + e;
            n2 = e;
          }
      ...
      return t.prototype.handleScroll = function(t2) {
        if (t2 && window && !t2.once) {
          var i = window.innerHeight + window.scrollY, n = t2.el.getBoundingClientRect(), s = n.top + n.height + window.pageYOffset;
          s < i && s > window.scrollY && t2.paused ? (t2.paused = false, setTimeout(function() {
            return t2.start();
          }, t2.options.scrollSpyDelay), t2.options.scrollSpyOnce && (t2.once = true)) : window.scrollY > s && !t2.paused && t2.reset();
        }
